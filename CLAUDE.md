...
```
Boutons : « Lancer une partie », « Arrêter » (visible pendant une action), « Tester les mouvements » (parcourt les 9 cases à vide), « Calibrer » (à venir). Vue caméra recadrée sur la zone calibrée, avec bascules « Repères » (superpose les 9 cases) et « Plein cadre ». ⚠️ Port **8080** par défaut : le 8000 est déjà pris sur le NUC.
